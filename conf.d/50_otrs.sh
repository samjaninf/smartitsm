...
VERSIONS="OTRS Help Desk 3.1.11, ReferenceIDoitObjects 0.5 (closed beta)"
URL="/otrs/index.pl"
...
function do_install {
    ...
    cd "$TMP_DIR" || return 1
    download http://ftp.otrs.org/pub/otrs/otrs-3.1.11.tar.bz2 || return 1
    logdebug "Extracting tarball..."
    tar xjf otrs-3.1.11.tar.bz2 || return 1
    logdebug "Moving files to destination directory..."
    mv otrs-3.1.11/ /opt/otrs/ || return 1
